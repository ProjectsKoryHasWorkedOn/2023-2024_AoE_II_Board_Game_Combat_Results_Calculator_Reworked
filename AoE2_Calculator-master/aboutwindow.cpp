    ...
    ui(new Ui::aboutwindow)
{
  ...
  ui->license_description_label->setText("If you found the program useful and would like to support its development, you may make a donation to a non-profit charitable organization like the <a href=\"https://www.australianwildlife.org/\" style=" + palettes.getLinkColor() + ">Australian Wildlife Conservancy (AWC)</a>");
