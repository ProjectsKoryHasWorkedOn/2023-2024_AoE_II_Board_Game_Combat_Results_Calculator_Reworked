                   ...
                   }}
{
  ...
  // @Phillip: Can we have aliases? For example, can "CHARLAMAGNE'S_PALACE_AT_AIX_LA'CHAPELLE_(BRITON)" be the same as "WONDER_(BRITON)"?
...
void MainWindow::updatePlayerNames(QString updatedPlayer1Name, QString updatedPlayer2Name){
   ui.player1UnitsLabel->setText("<font color=" + player1Color + ">" + player1Name + "'s"  + "</font>" + " " + "battle participant");
   ui.player1AssistingUnitsLabel->setText("<font color=" + player1Color + ">" + player1Name + "'s"  + "</font>" + " " + "battle assistant");
   ui.player1TechnologiesLabel->setText("<font color=" + player1Color + ">" + player1Name + "'s"  + "</font>" + " " + "technologies");
   ui.player1EventsLabel->setText("<font color=" + player1Color + ">" + player1Name + "'s"  + "</font>" + " " + "event cards");

   ui.player2UnitsLabel->setText("<font color=" + player2Color + ">" + player2Name + "'s"  + "</font>" + " " + "battle participant");
   ui.player2AssistingUnitsLabel->setText("<font color=" + player2Color + ">" + player2Name + "'s"  + "</font>" + " " + "battle assistant");
   ui.player2TechnologiesLabel->setText("<font color=" + player2Color + ">" + player2Name + "'s"  + "</font>" + " " + "technologies");
   ui.player2EventsLabel->setText("<font color=" + player2Color + ">" + player2Name + "'s"  + "</font>" + " " + "event cards");
}
...
void MainWindow::on_actionSet_name_of_player_1_triggered()
{
  ...
  bool ok;
  player1Name = QInputDialog::getText(this, tr("Enter player 1's name"),tr("Player 1's name:"), QLineEdit::Normal,"", &ok);
...
void MainWindow::on_actionSet_name_of_player_2_triggered()
{
  ...
  bool ok;
  player2Name = QInputDialog::getText(this, tr("Enter player 2's name"),tr("Player 2's name:"), QLineEdit::Normal,"", &ok);
