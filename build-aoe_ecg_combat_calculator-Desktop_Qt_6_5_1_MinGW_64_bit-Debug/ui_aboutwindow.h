...
public:
    ...
    void retranslateUi(QDialog *aboutwindow)
    {
        ...
        gitHubPageLabel->setText(QCoreApplication::translate("aboutwindow", "https://github.com/ProjectsKoryHasWorkedOn/AoE_II_Board_Game_Combat_Results_Calculator", nullptr));
